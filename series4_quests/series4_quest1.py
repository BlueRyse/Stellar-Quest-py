#as an example try to add a :pray: emoji to a new random account with stellar laboratory
#this account needs to have a threshold of 10 for ALL operations (like in SQ04:01). The new pray
#emoji signer will need to have a weight of 5. The master Weight will need to be 5 as well.
